...
public partial class MainWindow : Window
{
	...
	public MainWindow()
	{
		...
		ButtomMoveDown.Content = "Опустить";
		ButtomMoveDown.Click += (_, __) =>
		{
			var index = TasksList.SelectedIndex;
			if (index == -1) return;

			model.MoveDownItem(index);
			ButtomMoveDown.IsEnabled = true;
		};
		...
		foreach (var button in new[] { ButtonRemove, ButtonUndo, ButtonAdd, ButtonMoveUp, ButtomMoveDown }) // ButtonMoveUp
